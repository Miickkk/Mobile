    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: Center(
          child: Column(
            children: [
              ElevatedButton(onPressed: _adicionarImagem, child: Text("Adicionar Imagem")),
              CarouselSlider(
                ...
                child: Padding(
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index){
                      return Image.network(_imagens[index],fit:BoxFit.cover);
                    },),),
              )
            ],
          ),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: TextField(
          ...
          decoration: InputDecoration(hintText: "Insira URL da Imagem"),
        ),
        actions: [
          //botão de Cancelamento/Enviar
          TextButton(
